...
List <WebElement> FBlist = driver1.findElements(By.xpath("//span[@class='channel-icon facebook']"))
println(FBlist)
for(WebElement wi: FBlist)
{
	wi.click()
}

WebDriver driver2 = DriverFactory.getWebDriver()
List <WebElement> TWlist = driver2.findElements(By.xpath("//span[@class='channel-icon twitter']"))
println(TWlist)
for(WebElement wi: TWlist)
{
	wi.click()
}
