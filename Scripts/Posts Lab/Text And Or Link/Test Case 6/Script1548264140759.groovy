...
'Clicking on the "Ok" button of Select Profile(S)'
...
Thread.sleep(10000)
'Clicking on the "Ok" button of the "Please Select At Least one Profile" Popup.'
WebUI.click(findTestObject('Posts Page/Create Posts/Creating Text And Or Link Posts Section/Please Select At Least one Profile Popup/Ok Button'))
