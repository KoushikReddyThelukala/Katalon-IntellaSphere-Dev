...
WebUI.click(findTestObject('Posts Page/Create Posts/Profiles/Facebook Profiles/Sathyapage'))
...
'Clicking on the "Ok" button of the "Please Enter A Message" Popup.'
WebUI.click(findTestObject('Posts Page/Create Posts/Creating Text And Or Link Posts Section/Please Enter A Message Popup/Ok Button'))
